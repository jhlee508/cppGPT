...
# Description: This script dumps the GPT-2 small model into a binary file and an index file.
# Usage: python dump_tf_model.py
...
model_dir = "./assets"
ret_model_path = "./assets/model_file.bin"
ret_index_path = "./assets/model_index.json"
